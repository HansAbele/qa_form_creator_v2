#!/usr/bin/env python3
"""Deploy updated header (horizontal theme toggle) to server."""
import sys
import os
import paramiko
...
def main():
    ...
    cmd = (
        f"cd {REMOTE_ROOT} && "
        "docker compose -f docker-compose.prod.yml --env-file .env.production build app 2>&1 | tail -10 && "
