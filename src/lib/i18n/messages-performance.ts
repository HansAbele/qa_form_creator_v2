export const PERFORMANCE_ES_MESSAGES: Record<string, string> = {
  ...
  "Coaching time today": "Hora del coaching de hoy",
  "Select today's time": "Selecciona la hora de hoy",
  "Coaching now": "Coaching ahora",
  "Create coaching for today": "Crear coaching para hoy",
  "Choose a time for today's coaching": "Selecciona una hora para el coaching de hoy",
  "Coaching can only be created for today": "El coaching solo puede crearse para hoy",
  "Finish or pause the current timer before starting coaching now":
    "Finaliza o pausa el temporizador actual antes de iniciar el coaching ahora",
